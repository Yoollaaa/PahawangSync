...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F8FB] flex items-center justify-center p-4 md:p-6 font-sans">
      ...
      <div className="bg-white rounded-3xl md:rounded-[40px] w-full max-w-md p-6 md:p-10 shadow-2xl border border-slate-100">
        ...
        <h2 className="text-xl md:text-2xl font-bold text-[#0F172A] mb-1 md:mb-2 text-center">Selamat Datang Kembali</h2>
        <p className="text-slate-500 text-xs md:text-sm mb-6 md:mb-8 text-center font-medium">Masuk untuk melanjutkan petualanganmu.</p>
        ...
        <form onSubmit={handleLogin} className="space-y-4 md:space-y-5">
          ...
          <button 
            disabled={isLoading} 
            type="submit" 
            className={`w-full py-3.5 md:py-4 mt-2 md:mt-4 rounded-full font-bold text-white text-sm md:text-base transition-all ${isLoading ? 'bg-slate-400' : 'bg-[#0284C7] hover:bg-[#0369A1] shadow-lg shadow-[#0284C7]/30 md:hover:scale-[1.02] active:scale-95'}`}
          >
